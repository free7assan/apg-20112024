...
const defaultRoles = [
  {
    id: 1,
    name: 'Basic User',
    description: 'Can create and manage own playbooks',
    permissions: ['create_playbook', 'read_playbook', 'update_playbook', 'delete_playbook']
  },
  {
    id: 2,
    name: 'Premium User',
    description: 'Additional features and priority support',
    permissions: ['create_playbook', 'read_playbook', 'update_playbook', 'delete_playbook', 'advanced_features', 'priority_support']
  },
  {
    id: 3,
    name: 'Administrator',
